...
var validate = {
    ...
    name: {
        ...
        validateNameWithChineseAndEnGT2: function(value) {
            ...
            avalon.log(
                "验证：validateNameWithChineseAndEnGT2:",
                value,
                patt1.test(value)
            );
            avalon.log(
                "验证：validateNameWithChineseAndEnGT2:",
                validate.name.validateNameChinese(value)
            );

            if (
                validate.name.validateNameChinese(value) <= 10 &&
                validate.name.validateNameChinese(value) > 1
            ) {
            } else {
                result.tips =
